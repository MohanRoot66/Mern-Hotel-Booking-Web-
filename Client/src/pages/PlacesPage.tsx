        ...
        <div>
            { actions!=="new" && (
                <div className="text-center">
                    <Link className='inline-flex gap-1 text-white bg-primary px-6 py-2 rounded-full' to={"/account/places/new"}>
            ...
            actions=="new" && (
                <form>
                    ...
                    <p className='text-sm text-gray-500'>Title for your place , short and catchy as in advertisment</p>
                    <input type='text' placeholder='title, for my lovely apartment' />
                    ...
                    <div className='flex gap-2'> 
                        ...
                        <button className='bg-fray-200 px-4 rounded-2xl'>Add&nbsp;Photo</button>
                    </div>
                    <div className='mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
                        <button className='flex justify-center gap-1 border bg-transparent text-2xl text-gray-600 rounded-2xl p-8 text-center'>
                    ...
                    <div className='grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-6'>
                            <label className='border flex align-center p-4 rounded-2xl gap-2 cursor-pointer'>
                                <input type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
